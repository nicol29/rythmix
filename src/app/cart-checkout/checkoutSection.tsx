  ...
  return (
    <section className="py-10">
      <div className="flex flex-col items-center gap-10">
          ...
          { cartItems.length !== 0 ?
            ( cartItems.map(item => (
              <div key={item._id.toString()} className="flex items-center gap-2">
                <div className="flex gap-2 py-3 pl-2 flex-1">
                  <Link href={`/beat/${item.urlIdentifier}`} className="relative w-16 aspect-square self-center flex-shrink-0">
                  ...
                  <div className="flex flex-col flex-1">
                    ...
                    <span className="text-neutral-500 text-sm">{item.chosenLicense.licenseType} License {returnFormats(item)}</span>
        ...
        <div className="bg-neutral-800 border rounded border-neutral-700 w-11/12 p-4">
          ...
          <div className="py-4 flex flex-col gap-4">
            { cartItems.map(item => (
              <div key={item._id.toString()} className="flex items-center gap-2">
                ...
                <div className="max-w-[270px] truncate overflow-hidden flex-1">
